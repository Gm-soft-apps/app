    ...
    return (
        <div className="d-flex justify-content-center align-items-center h-100">
            <div id="loginPage" className="mx-1 card w-100 py-3">
                ...
                <form className="px-3 my-3" method="">
                    <div className="mb-3">
                    ...
                    <div className="mb-3">
                        ...
                        <input type="password" className="form-control p-2" id="password" name="password" placeholder="Enter Password" required/>
                    </div>
                    <div className="mb-3">
                        <button type="submit" className="btn btn-success w-100 p-2 fw-bold">Sign Up</button>
                    </div>
                    <div className="my-2">Already have an account? <a href="/login" className="text-decoration-none fw-semibold">Login</a></div>
                </form>
            </div>
        </div>
    );
...
export const onSubmitForm = async (formData) => {
    'use server'
    console.log("hi")
}
