import ReferralCopy from "app/ui/Dashboard/ReferralCopy";
    ...
    return (
        <div className="mx-2">
            ...
            <div className="row my-1">
                <table className="table table-bordered border-dark text-center">
                    <tbody>
                        ...
                        <tr>
                            <td className="p-1 fw-semibold text-primary">{referrals.length}</td>
                            <td className="p-1 fw-semibold text-primary">{referrals.length*5}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div className="fw-semibold my-2">
                ...
                <ReferralCopy protocol={protocal} host={host} referralCode={user.referralCode}/>
            </div>
            ...
            <div id="shareIcons" className="bg-white rounded-1 shadow-sm fs-1 d-flex justify-content-evenly align-items-center">
                ...
                <Link href={`https://api.whatsapp.com/send?text=${protocal + "://" + host}/register?ref=${user.referralCode}`} className="bi bi-whatsapp link-dark"></Link>
                <Link href={`https://www.facebook.com/sharer/sharer.php?u=${protocal + "://" + host}/register?ref=${user.referralCode}`} className="bi bi-facebook link-dark"></Link>
                <Link href={`https://telegram.dog/share/url?url=${protocal + "://" + host}/register?ref=${user.referralCode}`} className="bi bi-telegram link-dark"></Link>
