const Dashboard = () => {
    ...
    return (
        <>
            <div className="d-flex justify-content-between align-items-center mb-2 bg-white px-2 py-1">
            ...
            <div className="border border-dark p-2 bg-white mx-1">
                ...
                <button className="btn btn-success p-2 w-100">Complete Now</button>
            </div>

            <div className="row row-cols-3 bg-white position-fixed bottom-0 w-100 text-center">
                <div className="col fs-4">Refer <span className="bi bi-people fs-1"></span></div>
                <div className="col fs-4"><span className="bi bi-house-check fs-1"></span></div>
                <div className="col fs-4">wallet <span className="bi bi-wallet2 fs-1"></span></div>
            </div>
        </>
    )
}
