const Dashboard = () => {
    ...
    return (
        <>
            <div className="d-flex justify-content-between align-items-center mb-2 bg-white px-1 py-1 shadow-sm">
                <div className="fs-1 btn px-2"><span className="bi bi-person-check"></span></div>
                <div><h2>App Name</h2></div>
                <div className="fs-1 btn px-2"><span className="bi bi-list"></span></div>
            </div>
            ...
            <div className="border p-2 bg-white mx-1 rounded shadow">
            ...
            <div className="bg-white row text-center w-100 position-fixed bottom-0 shadow bg-success">
